...
test('Provided Project ID', () => {
  const gitlab = new Gitlab({ }, {token: '123', gistID: '123', baseURL: '', projectID: '123'});
...
test('public visibility', () => {
  const gitlab = new Gitlab({ }, {token: '123', gistID: '123', baseURL: '', projectID: '123', visibility: 'public'});
